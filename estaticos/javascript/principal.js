...
socket.on("mensaje-al-cliente",function(datosServidor){
	...
	//append AGREGA EL HTML ALFINAL DEL CONTENIDO de #mensajes
	$("#mensajes").append(caja);
	
});

//ESCUCHAMOS EL CLICK DEL BOTON DEL CHAT
//TAREA: CMABIAR A DELEGACION DE EVENTOS
$("#boton").click(function(){
	//val obtiene el texto que haya ecrito en elinput
	var mensaje = $("#mensaje-usuario").val();
	var usuario = $("#nombre-usuario").val();
	
	//emit 0 genera un evento (primer argumento)
...
//ESCUCHAMOS EL CLICK DE EL ANCHOR
//ME EPERMITE ESCUCHAR CUANDO EL USUARIO ESTA USANDO
//LAS FLECHITAS HACIA ATRAS O HACIA ADELNATE 
...
$("#link-blog").click(function() {
	...
	//History (CON HA MAYUSCULEA) es la libreria history.min.js
	//Tercer argumento = URL que vamos a mostrar en el navegador
	History.pushState({
